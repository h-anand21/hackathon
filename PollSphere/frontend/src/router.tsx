  ...
  component: () => (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans antialiased">
      <header className="bg-white shadow-sm py-4 px-8 flex justify-between items-center">
        <div className="font-extrabold text-2xl text-blue-600 tracking-tighter">PollSphere</div>
      </header>
      <main>
        <Outlet />
      </main>
...
const indexRoute = createRoute({
  ...
  component: () => (
    <div className="p-8 max-w-3xl mx-auto mt-10 text-center">
      ...
      <a href="/create-poll" className="bg-blue-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-700 transition shadow-lg">
